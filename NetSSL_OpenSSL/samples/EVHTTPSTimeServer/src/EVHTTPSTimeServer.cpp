...
// TimeServer.cpp
//
// This sample demonstrates the EVHTTPServer and related classes.
//
...
class TimeRequestHandlerFactory: public EVHTTPRequestHandlerFactory
{
public:
...
protected:
	...
	int main(const std::vector<std::string>& args)
	{
		...
		else
		{
			...
			EVHTTPServer srv(new TimeRequestHandlerFactory(format), svs, new HTTPServerParams);
